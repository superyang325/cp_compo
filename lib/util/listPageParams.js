...
var listPageParams = {
    ...
    if (dateFields.length) {
      dateFields.forEach(function (dateField) {
        if (typeof formParams[dateField] === 'string') {
          formParams[dateField] = (0, _moment.default)(formParams[dateField], dateFormat);
        } else if (Array.isArray(formParams[dateField])) {
          for (var i = 0; i < formParams[dateField].length; i++) {
            formParams[dateField][i] = (0, _moment.default)(formParams[dateField][i], dateFormat);
          }
        }
      });
    }
  ...
  checkMoment: function checkMoment(formParams, dateFormat, dateFields) {
    ...
    allFields.forEach(function (field) {
      ...
      if ((0, _typeof2.default)(curValue) === 'object') {
        if (Array.isArray(curValue)) {
          var dateArr = [];

          for (var i = 0; i < curValue.length; i++) {
            if (_moment.default.isMoment(curValue[i])) {
          ...
          if (_moment.default.isMoment(curValue)) {
...
exports.listPageParams = listPageParams;