...
exports.getParentOrderListApi = getParentOrderListApi;
exports.getChildOrderListApi = getChildOrderListApi;
exports.getChildOrderDetailApi = getChildOrderDetailApi;
exports.getProductListApi = getProductListApi;
exports.modifyOrderStatusApi = modifyOrderStatusApi;
exports.refundOrderTransApi = refundOrderTransApi;
exports.getCompanyListApi = getCompanyListApi;
exports.getShopListApi = getShopListApi;
exports.getReasonApi = getReasonApi;
exports.getPriceApi = getPriceApi;
exports.afterSaleApplyApi = afterSaleApplyApi;
exports.uploadImgApi = uploadImgApi;
exports.exportCSVApi = exportCSVApi;
...
var _constant = require("../order/constant");
...
function getParentOrderListApi(params) {
  return new Promise(function (resovle, reject) {
    return (0, _send.default)({
      url: 'order/admin-order-main-list',
      method: 'POST',
      data: Object.assign((0, _objectConvert.objectToLine)(params), {
...
function getChildOrderListApi(params) {
  return new Promise(function (resovle, reject) {
    return (0, _send.default)({
...
function getChildOrderDetailApi(data) {
  return new Promise(function (resovle, reject) {
    return (0, _send.default)({
      url: 'order/admin-order-detail',
      method: 'POST',
      data: (0, _objectConvert.objectToLine)(data)
    }).then(function (res) {
      if (res.data.code === 200) {
        ...
        resovle({
          ...
          logList: _data.status.map(function (item) {
            return {
              ...
              operatorStatus: _constant.ORDERSTATUS[item.order_status + '']
            };
          }),
...
function modifyOrderStatusApi(data) {
  return new Promise(function (resovle, reject) {
    (0, _send.default)({
      url: 'order/modify-status',
      method: 'POST',
      data: Object.assign((0, _objectConvert.objectToLine)(data), {
        extra: {
...
function refundOrderTransApi(data) {
  return new Promise(function (resovle, reject) {
    (0, _send.default)({
  ...
  if (basic.mp_platform === 'cp_plus') {
    ...
    return new Promise(function (resovle, reject) {
      ...
      (0, _send.default)({
        ...
        }, (0, _objectConvert.objectToLine)(params))
      }).then(function (res) {
        if (res.data.code === 0) {
          var list = res.data.data.list;
          list = list.map(function (item) {
...
function afterSaleApplyApi() {
  var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return new Promise(function (resovle, reject) {
    var productInfo = data.productInfo;
    data.productInfo = (0, _objectConvert.arrToLine)(productInfo);
    return (0, _send.default)({
